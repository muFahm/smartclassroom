...
urlpatterns = [
    ...
    path("me/schedule/", MyScheduleView.as_view(), name="my_schedule"),
    path("me/results/", MyResultsView.as_view(), name="my_results"),
    path("me/notes/", MyNotesView.as_view(), name="my_notes"),
    path("me/activity/", MyActivityView.as_view(), name="my_activity"),
