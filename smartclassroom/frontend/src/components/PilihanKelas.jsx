...
export default function PilihanKelas() {
  const [selectedKelas, setSelectedKelas] = useState('701');
  ...
  return (
    <div className="pilihan-kelas-card">
      ...
      <div className="dropdown-container">
        ...
        >
          <span className="dropdown-selected">Kelas {selectedKelas}</span>
          <svg 
        ...
        {isOpen && (
          <div className="dropdown-menu">
            {kelasOptions.map((kelas) => (
              <div
                key={kelas}
                className={`dropdown-item ${selectedKelas === kelas ? 'active' : ''}`}
