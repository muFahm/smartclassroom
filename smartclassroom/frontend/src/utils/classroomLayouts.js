...
export const CLASSROOM_LAYOUTS = {
  "701": {
    ...
    description: "5 baris: 2 baris depan (6 kursi) + 3 baris belakang (6 kursi dengan indent)",
    layout: [
  ...
  "702": {
    ...
    totalSeats: 50,
    type: "standard-offset",
    description: "8 baris: 2 baris depan (7 kursi dengan offset) + 6 baris belakang (6 kursi dengan indent)",
    layout: [
